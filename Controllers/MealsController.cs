...
namespace Book_My_Table.Controllers
{
    public class MealsController : Controller
    {
        ...
        public MealsController(CustomerReg context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MealId,Name,Timing")] Meal meal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MealId,Name,Timing")] Meal meal)
        {
            if (id != meal.MealId)
            {
                return NotFound();
